...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            var message = 'Welcome to the Whale Songs sample pack. You can say, play the audio to begin the songs.';
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to the Whale Songs sample pack. You can say, play the audio to begin the songs.';
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'YWelcome to the Whale Songs sample pack. You can say, play the audio to begin the songs. ' +
...
var controller = function () {
    return {
        play: function () {
            ...
            var message = 'This is the song of a ' + podcast.title;
            this.response.speak(message);
